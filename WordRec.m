...
%  testArray = {cepstraTwit cepstraTweet cepstraClick cepstraChit...
%      cepstraChirp cepstraCough cepstraSneeze cepstraSqueak cepstraDog...
%      cepstraCat cepstraDoor};
...
if min(log_like)>6500
        disp(' ');
        disp('Sound made: Background noise'); 
else
    if (Spoken_word < 6)
        disp(' ');
